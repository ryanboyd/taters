...
* **Text:** `analyze_with_dictionaries`, `analyze_with_archetypes`, `analyze_readability`, `analyze_word_count`, `analyze_lexical_richness`, `analyze_ngram_frequencies`, `analyze_parts_of_speech`, `analyze_cohesion`, `build_doc_term_matrix`, `topic_model_mem`, `apply_mem_model`, `train_word_vectors`, `import_word_vectors`, `apply_word_vectors`, `describe_word_vectors`, `extract_sentence_embeddings`, `extract_transformer_embeddings`, `adapt_encoder`, `finetune_text_predictor`, `apply_text_predictor`, `convert_subtitles` → `t.text.<name>(...)`.
