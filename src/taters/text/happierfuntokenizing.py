    ...
    def __html2unicode(self, s):
        ...
        for ent in ents:
            ...
            try:            
                ...
                pass                    
        # Once, after the loop over the *other* entities: inside it, this ran
        # zero times when &amp; was the only entity in the text, so the same
        # "&amp;" tokenized as "and" in one document and as "&", "amp", ";"
        # in the next depending on unrelated content.
        s = s.replace(amp, " and ")
        return s
